...
words = ["elephant", "sunshine", "keyboard", "adventure", "butterfly",
         "chocolate", "happiness", "symphony", "rainbow", "blueprint",
         "velocity", "celebrate", "universe", "galaxy", "treasure",
         "whistle", "xylophone", "quasar", "wonderland", "pajamas",
         "radiant", "serendipity", "mysterious", "journey", "acoustic",
         "blueprint", "harmony", "cinnamon", "quicksilver", "blossom"
         ]
